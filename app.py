...
expected_columns = ['age', 'height_cm', 'weight_kg', 'body fat_%', 'diastolic', 'gripForce', 'sit_bend', 'sit_ups', 'broad_jump', 'M']
...
if st.button("Predict"):
    ...
    if prediction[0] == 0:
        ...
        st.write(f"You have an average body performance and can improve")
    else:
